...
func (js *JsonStream) ToFloat32() float32 {
	return clCommon.Float32(string(js.ToStr()))
}

// 转换成字符串
func (js *JsonStream) ToFloat64() float64 {
	return clCommon.Float64(string(js.ToStr()))
}

// 转换成字符串
func (js *JsonStream) ToInt32() int32 {
	return clCommon.Int32(string(js.ToStr()))
}

// 转换成字符串
func (js *JsonStream) ToUint32() uint32 {
	return clCommon.Uint32(string(js.ToStr()))
}

// 转换成字符串
func (js *JsonStream) ToInt64() int64 {
	return clCommon.Int64(string(js.ToStr()))
}

// 转换成字符串
func (js *JsonStream) ToUint64() uint64 {
	return clCommon.Uint64(string(js.ToStr()))
}

// 转换成bool
func (js *JsonStream) ToBool() bool {
	return clCommon.Bool(string(js.ToStr()))
}
