...
func (this *jsonItem) StackParseTree() interface{} {
	...
	if this.data.dataType == JSON_TYPE_MAP {
		...
		return clCommon.Float64(this.data.ToStr())
...
func (js * JsonMap) GetUint32(key string, def uint32) uint32 {
	if val, ok := (*js)[key]; ok {
		return clCommon.Uint32(val.data.ToStr())
	}
	return def
}
...
func (js * JsonMap) GetUint64(key string, def uint64) uint64 {
	if val, ok := (*js)[key]; ok {
		return clCommon.Uint64(val.data.ToStr())
	}
	return def
}
...
func (js * JsonMap) GetInt32(key string, def int32) int32 {
	if val, ok := (*js)[key]; ok {
		return clCommon.Int32(val.data.ToStr())
	}
	return def
}
...
func (js * JsonMap) GetFloat32(key string, def float32) float32 {
	if val, ok := (*js)[key]; ok {
		return clCommon.Float32(val.data.ToStr())
	}
	return def
}
...
func (js * JsonMap) GetFloat64(key string, def float64) float64 {
	if val, ok := (*js)[key]; ok {
		return clCommon.Float64(val.data.ToStr())
	}
	return def
}
